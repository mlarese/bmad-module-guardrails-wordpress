...
2. **Convocate ed escluse** — figura e aggancio concreto, oppure motivo dell'esclusione. L'elenco copre **tutte** le figure del roster: una figura che non compare né fra le convocate né fra le escluse è stata dimenticata, non valutata, e nessuno se ne accorge leggendo il riepilogo.
